  ...
  <div>
    ...
    <el-card>
      <div style="margin-top: 15px;">
        <el-row :gutter="20">
          <el-col :span="5">
            <el-input placeholder="请输入操作员(id)" v-model="queryInfo.query" clearable></el-input>
          </el-col>
          <el-col :span="3.1">
            <el-date-picker
      ...
      <el-table :data="exceptionLogList" border stripe :default-sort="{prop:'createTime',order:'descending'}">
        <el-table-column type="index"></el-table-column>
        <el-table-column label="ID" prop="id"></el-table-column>
        <el-table-column label="异常名称" prop="excName"></el-table-column>
        <el-table-column label="操作路径" prop="operUri"></el-table-column>
        <el-table-column label="操作方法" prop="operMethod"></el-table-column>
        <el-table-column label="操作员" prop="operUserId"></el-table-column>
    ...
    export default {
        ...
        methods:{
            getExceptionLogList(){
                let vm = this;
                this.axios({
                    url: '/exceptionLog/admin/getExceptionLogBriefList',
                    method: 'get',
                    params: {
                    ...
                    if(res.data.code === 200){
                        vm.exceptionLogList = res.data.data.exceptionLogBriefVos;
